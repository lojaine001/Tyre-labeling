"""
Flatten yolo_dataset (train/val/test split) into
yolo_dataset_with_background (flat: images/ + labels/ + dataset.yaml).
...
SRC  = Path(r"E:\labeling\yolo_dataset")
DST  = Path(r"E:\labeling\yolo_dataset_with_background")
...
yaml = f"""# With-background tyre dataset — {copied} images, flat (no split)
